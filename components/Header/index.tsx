    ...
    <View className="flex-row items-center justify-between px-12 pt-8 pb-4 bg-[#02100E]">
      ...
      >
        ...
        className="flex-1 flex-col items-left">
          <Text className="font-semibold font-unica text-white text-5xl text-center">{user.name}</Text>
          <View className="flex-grow flex-row">
            <Text className="flex-1 text-2xl text-white justify-start">Level: {user.level}</Text>
            <Text className="text-2xl text-white justify-end">{user.xp} / {user.level*10}</Text>
          </View>
